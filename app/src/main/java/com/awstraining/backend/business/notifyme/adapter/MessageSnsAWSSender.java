...
public class MessageSnsAWSSender implements MessageSender {
    ...
    public void send(String text) {
        ...
        final PublishResult publishResult = this.sns.publish(publishRequest);
        LOGGER.info("Message published successfully to topic {} with id {}",snsTopic, publishResult.getMessageId());
