...
public class TranslatorImpl implements Translator {
    ...
    public String translate(NotifyMeDO notifyMeDO) {
        ...
        final TranslateTextResult translateTextResult = this.amazonTranslate.translateText(translateTextRequest);

        LOGGER.info("Translated text: {}",translateTextResult.getTranslatedText());
