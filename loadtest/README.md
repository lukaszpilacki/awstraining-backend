...
```
aws ecr get-login-password --region eu-central-1 --profile [PROFILE] | docker login --username AWS --password-stdin 741448916324.dkr.ecr.eu-central-1.amazonaws.com
```
...
```
docker tag backend-loadtest:latest 741448916324.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```

```
docker push 741448916324.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```
